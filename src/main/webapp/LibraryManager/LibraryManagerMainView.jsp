...
<head>
    <meta charset="UTF-8">
    <title>Libman - Library Manager Main View</title>
...
<div class="container dashboard">
    <div class="text-center mb-5">
        <h1 class="fw-bold text-white">📊 Library Manager Main View</h1>
    </div>

    <div class="text-center mt-5">
        <a href="SelectStatisticReportTypeView.jsp" class="btn btn-report btn-lg">
